    ...
    class Qiub_Slideshow_Block_Adminhtml_Slides_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
    {
        protected function _prepareForm()
        {
            $form = new Varien_Data_Form();
            $this->setForm($form);
            $fieldset = $form->addFieldset('slides_form', array('legend'=>Mage::helper('slideshow')->__('Slide information')));
			...
			$fieldset->addField('filename', 'image', array(
	 		...
	 		/*
				...
				<h2>Every Summer <span>Has a Story...</span></h2>
				<p>Holiday Resort Collection 2013</p>
				<a class="button">View collection</a>
